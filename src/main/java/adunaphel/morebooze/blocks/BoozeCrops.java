...
/**
 * 
 * what the fuck do the "func_<i>_<l>" mean? well, here's a list:
 * func_149851_a returns "true" if bonemeal is allowed, false if not.
 * func_149852_a returns "true" at the same time bonemeal is used, if the crop is not fully grown.
 * func_149853_b processes the actual logic of growing the crop, which usually increases metadata/replacing the block.
 *
 */
public class BoozeCrops extends BlockBush implements IGrowable
{
